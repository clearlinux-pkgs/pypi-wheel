...
Source0  : https://files.pythonhosted.org/packages/2e/c6/af5def6796940a8bd602d815f7f495f32d833c81b38d055ca0b23ab3b804/wheel-0.38.3.tar.gz
...
%prep
%setup -q -n wheel-0.38.3
cd %{_builddir}/wheel-0.38.3
pushd ..
cp -a wheel-0.38.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667958762
