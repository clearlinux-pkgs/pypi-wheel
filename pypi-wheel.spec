...
Source0  : https://files.pythonhosted.org/packages/a2/b8/6a06ff0f13a00fc3c3e7d222a995526cbca26c1ad107691b6b1badbbabf1/wheel-0.38.4.tar.gz
...
%prep
%setup -q -n wheel-0.38.4
cd %{_builddir}/wheel-0.38.4
pushd ..
cp -a wheel-0.38.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668097497
