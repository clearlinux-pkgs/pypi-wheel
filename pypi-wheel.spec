...
Source0  : https://files.pythonhosted.org/packages/b7/a0/95e9e962c5fd9da11c1e28aa4c0d8210ab277b1ada951d2aee336b505813/wheel-0.44.0.tar.gz
...
%prep
%setup -q -n wheel-0.44.0
cd %{_builddir}/wheel-0.44.0
pushd ..
cp -a wheel-0.44.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722871587
