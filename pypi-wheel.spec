...
Source0  : https://files.pythonhosted.org/packages/fb/d0/0b4c18a0b85c20233b0c3bc33f792aefd7f12a5832b4da77419949ff6fd9/wheel-0.41.3.tar.gz
...
%prep
%setup -q -n wheel-0.41.3
cd %{_builddir}/wheel-0.41.3
pushd ..
cp -a wheel-0.41.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698684096
