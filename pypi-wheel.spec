...
Source0  : https://files.pythonhosted.org/packages/fc/ef/0335f7217dd1e8096a9e8383e1d472aa14717878ffe07c4772e68b6e8735/wheel-0.40.0.tar.gz
...
%prep
%setup -q -n wheel-0.40.0
cd %{_builddir}/wheel-0.40.0
pushd ..
cp -a wheel-0.40.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678891769
