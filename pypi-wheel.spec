...
Source0  : https://files.pythonhosted.org/packages/a4/5b/0718aa11e3360f97feb81ddcb19cbb9306df0a17bef7c360f8939d2629b8/wheel-0.38.2.tar.gz
...
%prep
%setup -q -n wheel-0.38.2
cd %{_builddir}/wheel-0.38.2
pushd ..
cp -a wheel-0.38.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667845977
