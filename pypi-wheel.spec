...
Source0  : https://files.pythonhosted.org/packages/7a/b0/29c0c8c6f8cebeb0de4c17bc44365cba0b35cb4246e4a27a7e12ecf92d73/wheel-0.38.1.tar.gz
...
%prep
%setup -q -n wheel-0.38.1
cd %{_builddir}/wheel-0.38.1
pushd ..
cp -a wheel-0.38.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667578985
