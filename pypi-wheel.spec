...
Source0  : https://files.pythonhosted.org/packages/b8/d6/ac9cd92ea2ad502ff7c1ab683806a9deb34711a1e2bd8a59814e8fc27e69/wheel-0.43.0.tar.gz
...
%prep
%setup -q -n wheel-0.43.0
cd %{_builddir}/wheel-0.43.0
pushd ..
cp -a wheel-0.43.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710202921
