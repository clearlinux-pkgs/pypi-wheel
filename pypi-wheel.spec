...
Source0  : https://files.pythonhosted.org/packages/fb/62/e90918c4558b002726ab930863c0cbd3e7cf9a7befa1d4a1a240cecdb379/wheel-0.46.1.tar.gz
...
%prep
%setup -q -n wheel-0.46.1
cd %{_builddir}/wheel-0.46.1
pushd ..
cp -a wheel-0.46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744160266
